      ...
      <View style={styles.section}>
        <View style={styles.sectionHeader}>
          <View style={styles.sectionTitleContainer}>
            ...
            <Text style={[styles.sectionTitle, { color: colors.text }]}>
              {user?.university ? `From ${user.university}` : 'From Your University'}
            </Text>
          </View>
        ...
        <FlatList
          ...
          renderItem={({ item, index }) => (
            ...
            >
              <TouchableOpacity
                style={styles.universityProductCard}
              ...
              >
                <View style={styles.universityProductImageContainer}>
                  {item.images && item.images.length > 0 ? (
                    ...
                    <View style={[styles.universityProductImagePlaceholder, { backgroundColor: colors.border }]}>
                      <Ionicons name="image" size={24} color={colors.textTertiary} />
                    </View>
                  )}
                  <View style={[styles.universityBadge, { backgroundColor: colors.primary }]}>
                    <Ionicons name="school" size={12} color="#FFFFFF" />
                    <Text style={styles.universityBadgeText}>Campus</Text>
                  </View>
                </View>
                <View style={styles.universityProductInfo}>
                  <Text style={[styles.universityProductTitle, { color: colors.text }]} numberOfLines={2}>
                    {item.title}
                  </Text>
                  <Text style={[styles.universityProductPrice, { color: colors.primary }]}>
                    ${item.price.toFixed(2)}
                  </Text>
                  <View style={styles.universityProductMeta}>
                    <Text style={[styles.universityProductCategory, { color: colors.textTertiary }]}>
                      {item.category}
                    </Text>
              ...
              >
                <Card style={styles.recommendedCardContent}>
                  {item.images && item.images.length > 0 ? (
                    ...
                    <View style={[styles.recommendedImagePlaceholder, { backgroundColor: colors.border }]}>
